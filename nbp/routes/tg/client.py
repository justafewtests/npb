...
from nbp.config import ClientConstants, RegistrationConstants, MasterConstants, CommonConstants
...
from nbp.tg.models import AppointmentModel
...
from nbp.routes.tg.registration_form import _handle_sub_service, _handle_start_edit_phone_number, \
